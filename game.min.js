...
else{ig.game.restartGame();ig.game.bigfail.play();}}},draw:function(){this.ctx.save();this.ctx.fillStyle='rgba('+this.color.r+','+this.color.g+','+this.color.b+','+this.alpha+')';this.ctx.beginPath();this.ctx.arc(this.pos.x+this.size.x/2,this.pos.y+this.size.y/2,this.radius,0,2*Math.PI);if(this.highlighted){this.ctx.shadowBlur=50;this.ctx.shadowColor=this.color;}
